...
train_data = preprocess_translation_dataset('D:/IIITH/my_scan_project/data/simple_split/tasks_train_simple.txt')
...
torch.save(train_dataset.input_vocab, 'input_vocab.pth')
torch.save(train_dataset.output_vocab, 'output_vocab.pth')
